...
extension JSONDecoder {
    ...
    public func decode<T>(_ type: T.Type, from data: Data, keyPath: String, separator: Character = ".") throws -> T
    where T: Decodable {
    ...
    public func decode<T>(
        _ type: T.Type, from dict: [String: Any], keyPath: String? = nil, separator: Character = "."
